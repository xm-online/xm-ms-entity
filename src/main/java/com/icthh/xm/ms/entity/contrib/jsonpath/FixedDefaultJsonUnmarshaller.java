package com.icthh.xm.ms.entity.contrib.jsonpath;
 ...
 */
public class FixedDefaultJsonUnmarshaller implements JsonUnmarshaller {

    private static final Logger LOG = LoggerFactory.getLogger(FixedDefaultJsonUnmarshaller.class);
     ...
     * Default constructor.
     */
    public FixedDefaultJsonUnmarshaller() {
     ...
     */
    public FixedDefaultJsonUnmarshaller(final ObjectMapper objectMapper) {
     ...
     */
    private <T> T recursivelyProcessAllFields(final T currentObject, final ReadContext jwayReadContext,
        final Collection<String> parentJsonPath) throws IOException {
        ...
        try {
            ...
            for (Field field : declaredFields) {
                ...
                if (candidateField.isAppropriateForJsonPathUnmarshalling()) {
                    ...
                    performJsonPathUnmarshalling(jwayReadContext, currentObject, field, jsonPathOnField,
                        parentJsonPathString);
                }
    ...
    private void processChildFields(final CandidateField candidateField, final Object resultObject,
        final ReadContext jwayReadContext, final Collection<String> parentJsonPath)
        ...
        if (reflectionUtil.shouldConstituentMembersBeUnmarshalled(field.getType())) {
            ...
            final Collection<String> currentJsonPath = jsonPathUtil
                .resolveRelativeJsonPaths(candidateField, parentJsonPath);
     ...
     */
    private void unmarshalArrayOrList(final Object fieldValue, final ReadContext jwayReadContext,
     ...
     */
    private <T> void performJsonPathUnmarshalling(final ReadContext jwayReadContext, final T resultObject,
        final Field field,
     ...
     */
    private Object readValueFromJsonTree(final ReadContext jwayReadContext, final String jsonPath,
