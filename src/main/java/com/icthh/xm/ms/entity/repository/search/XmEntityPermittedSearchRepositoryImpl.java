...
public class XmEntityPermittedSearchRepositoryImpl extends PermittedSearchRepositoryImpl implements XmEntityPermittedSearchRepository {

    private final ElasticsearchOperations elasticsearchOperations;

    public XmEntityPermittedSearchRepositoryImpl(ElasticsearchOperations elasticsearchOperations) {
