...
public interface XmEntityService extends ResourceRepository {
    ...
    Page<XmEntity> search(Templateable templateable, Pageable pageable, String privilegeKey);
    ...
    Page<XmEntity> searchByQueryAndTypeKey(Templateable templateable, String typeKey, Pageable pageable, String privilegeKey);
