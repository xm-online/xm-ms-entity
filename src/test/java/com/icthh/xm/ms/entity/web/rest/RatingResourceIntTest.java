...
public class RatingResourceIntTest extends AbstractJupiterSpringBootTest {
    ...
    @Test
    @Transactional
    @Disabled("see RatingResourceExtendedIntTest.checkStartDateIsNotRequired instead")
