...
/**
 * End-to-end: HTTP URL string (query params for filters, full text, paging, sorting) → MockMvc →
 * resource → service → real PostgreSQL (Testcontainers) → JSON response.
 */
@Transactional
@WithMockUser(authorities = "SUPER-ADMIN")
public class XmEntityDbSearchResourceE2eIntTest extends AbstractPostgresIntTest {
    ...
    @Test
    public void getWithFiltersFullTextPagingAndJsonbSort() throws Exception {
    ...
    @Test
    public void getSortedByColumnDescThenJsonbAsc() throws Exception {
    ...
    @Test
    public void getWithNestedJsonbFilterAndIncludeSubTypesFalse() throws Exception {
    ...
    public void linkCandidatesAndTargetsByUrl() throws Exception {
        ...
        // links of alpha filtered by target jsonb field
